<?php 
    ...
    $queryUser = "SELECT * FROM psicologos WHERE email= '{$emailUser}'";
    $resUser = $conexao -> query($queryUser);

    $row = $resUser -> fetch_assoc();
    
    $typeUser = $row['tipo_user'];
?>
        ...
        <nav>
            <ul class="menu">
                ...
                <?php 
                    ...
                    }else if ($typeUser == 'Co' && $_SESSION['tipo_usuario'] == 'psicologo') {
            ...
            <?php while($psicologo = $result->fetch_assoc()): ?>
                ...
                <div class="card">
                    ...
                    <div class="card_superior">
                        <div class="lado1">
                            <div class="avatar"><img src="<?php echo $psicologo["photo_perfil"]?>" alt="picture" onclick="window.location.href='agendamento.php?psi=<?php echo urldecode($psicologo['nome']) ?>&id=<?php echo $psicologo['id'] ?>'"></div>
                            <div class="content">
                                <h4 class="perfil"><?php echo $psicologo["nome"]?></h4>
                                <p class="especialidade"><?php echo $psicologo["especialidade"]?></p>
                                <p class="crp"><?php echo $psicologo["crp"]?> | CRP</p>
                                <section class="regular">
                    ...
                    <div class="card_inferior">
                        <p class="resumo"><?php echo $resumo = textoLongo($psicologo["resumo"], 200)?>
